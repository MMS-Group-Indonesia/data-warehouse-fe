<!-- Modal upload -->
<div class="modal fade" id="modalRequestUpdate" data-bs-backdrop="static" data-bs-keyboard="false" style="" tabindex="" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- Modal Remove -->
<div class="modal fade" id="modalRemove" data-bs-backdrop="static" data-bs-keyboard="false" style="" tabindex="" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xxl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Request Update Remove</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="formRemove" method="post" action="/api/request-update/remove" >
				<div class="box box-info">
					<div class="box-body">
				        <h3 class="seo-info">Remove Data</h3>
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Periode </label>
							<div class="row">
								<div class="col-sm-6" style="padding-top:6px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label"></label>
							<div class="col-sm-6">
							<button type="submit" class="btn btn-success pull-left" name="form1" id="checkPeriodeExists" >Submit</button>
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
							</div>
						</div>
					</div>
